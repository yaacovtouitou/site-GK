 ...
 */
final class Version20260106172043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD login_streak INT DEFAULT 0 NOT NULL, ADD last_login_date DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP login_streak, DROP last_login_date');
    }
}
